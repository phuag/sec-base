...
public class ElasticSearch {
    ...
    public static class ElasticMeta {
        ...
        public List<String> getAllIndices() throws IOException {
            ...
            List<Map<String, Object>> list = JSONUtils.parseObject(response.getEntity().getContent(), Map.class);
            list.forEach(v -> {
        ...
        public List<String> getTypes(String index) throws IOException {
            ...
            Response response = restClient.performRequest(request);
            Map<String, Map<String, Object>> result = JSONUtils.parseObject(response.getEntity().getContent(), Map.class);
