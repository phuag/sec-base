/*
 ...
 Source Server         : hdfstest
 Source Server Type    : MySQL
 Source Server Version : 80019
 Source Host           : localhost:3306
 Source Schema         : hdfstest

 Target Server Type    : MySQL
 Target Server Version : 80019
 File Encoding         : 65001

 Date: 11/06/2020 15:59:46
*/
...
CREATE TABLE `capacity`  (
  ...
  `total_capacity` bigint(0) NULL DEFAULT NULL COMMENT '总容量',
  `used_capacity` bigint(0) NULL DEFAULT NULL COMMENT '使用容量',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `index_user_id`(`user_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '容量表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sec_file`  (
  ...
  `original_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '源名称',
  `file_size` int(0) NULL DEFAULT NULL COMMENT '文件大小',
  `file_type` int(0) NULL DEFAULT NULL COMMENT '文件类型',
  `file_location` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '文件地址',
  ...
  `upate_by` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '更新者',
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `index_file_id`(`file_id`) USING BTREE
...
CREATE TABLE `share`  (
  `id` int(0) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `share_id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '分享ID',
  `theme` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '分享主题',
  `user_id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '用户ID',
  `lock_whether` int(0) NULL DEFAULT NULL COMMENT '是否加密',
  `share_password` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '分享密码',
  `visit_count` int(0) NULL DEFAULT NULL COMMENT '浏览次数',
  `save_count` int(0) NULL DEFAULT NULL COMMENT '保存次数',
  `download_count` int(0) NULL DEFAULT NULL COMMENT '下载次数',
  `multi_whether` int(0) NULL DEFAULT NULL COMMENT '是否多文件',
  `expiration` datetime(0) NULL DEFAULT NULL COMMENT '过期时间',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `index_share_id`(`share_id`) USING BTREE
...
-- ----------------------------
-- Table structure for share_map
-- ----------------------------
DROP TABLE IF EXISTS `share_map`;
CREATE TABLE `share_map`  (
  `id` int(0) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `share_id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '分享ID',
  `virtual_address_id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '虚拟地址ID',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '分享文件对应表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of share_map
-- ----------------------------
...
CREATE TABLE `staff`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `staff_del_flag`(`del_flag`) USING BTREE,
  INDEX `staff_update_date`(`update_date`) USING BTREE
...
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '多级字典表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_menu`  (
  `id` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '编号',
  `name` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '名称',
  `code` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '识别代码',
  `permission` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '权限标识',
  `permission_code` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '权限码',
  `is_required` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '0' COMMENT '是否在必须的项',
  `create_by` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '创建者',
  `create_date` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `update_by` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '更新者',
...
-- Records of sys_menu
-- ----------------------------
INSERT INTO `sys_menu` VALUES ('1001', '系统管理员', 'sysUser', '查看', 'sysUser:list', '1', '1', '2020-04-24 14:11:21', '1', '2020-04-24 15:23:16', NULL, '0');
INSERT INTO `sys_menu` VALUES ('1002', '系统管理员', 'sysUser', '添加', 'sysUser:add', '0', '1', '2020-04-24 14:13:40', '1', '2020-04-24 15:23:18', NULL, '0');
INSERT INTO `sys_menu` VALUES ('1003', '系统管理员', 'sysUser', '修改', 'sysUser:update', '0', '1', '2020-04-24 14:13:40', '1', '2020-04-24 15:23:20', NULL, '0');
INSERT INTO `sys_menu` VALUES ('1004', '系统管理员', 'sysUser', '删除', 'sysUser:delete', '0', '1', '2020-04-24 14:13:40', '1', '2020-04-24 15:23:23', NULL, '0');
INSERT INTO `sys_menu` VALUES ('1011', '系统角色', 'sysRole', '查看', 'sysRole:list', '1', '1', '2020-04-24 14:11:21', '1', '2020-04-24 15:23:33', NULL, '0');
INSERT INTO `sys_menu` VALUES ('1012', '系统角色', 'sysRole', '添加', 'sysRole:add', '0', '1', '2020-04-24 14:11:21', '1', '2020-06-10 17:22:23', NULL, '0');
INSERT INTO `sys_menu` VALUES ('1013', '系统角色', 'sysRole', '修改', 'sysRole:update', '0', '1', '2020-04-24 14:11:21', '1', '2020-06-10 17:22:28', NULL, '0');
INSERT INTO `sys_menu` VALUES ('1014', '系统角色', 'sysRole', '删除', 'sysRole:delete', '0', '1', '2020-04-24 14:11:21', '1', '2020-06-10 17:22:36', NULL, '0');
INSERT INTO `sys_menu` VALUES ('1021', '系统备份', 'sysBackup', '查看', 'sysBackup:list', '1', '1', '2020-04-24 14:11:21', '1', '2020-04-24 15:24:21', NULL, '0');
INSERT INTO `sys_menu` VALUES ('1022', '系统备份', 'sysBackup', '添加', 'sysBackup:add', '0', '1', '2020-04-24 14:11:21', '1', '2020-04-24 15:25:59', NULL, '0');
INSERT INTO `sys_menu` VALUES ('1023', '系统备份', 'sysBackup', '修改', 'sysBackup:update', '0', '1', '2020-04-24 14:11:21', '1', '2020-04-24 15:26:06', NULL, '0');
INSERT INTO `sys_menu` VALUES ('1024', '系统备份', 'sysBackup', '删除', 'sysBackup:delete', '0', '1', '2020-04-24 14:11:21', '1', '2020-04-24 15:26:13', NULL, '0');
...
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '角色-机构' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_user`  (
  ...
  `birth` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0),
  `email` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '邮箱',
  `phone` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '电话',
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', '1', '2', 'thinkgem', '02a3f0772fcca9f415adc990734b45c6f059c7d33ee28362c4852032', '0001', '系统管理员', '男', '2017-12-29 14:46:13', 'thinkgem@163.com', '8675', '8675', '', NULL, '0:0:0:0:0:0:0:1', '2020-04-25 09:48:46', '1', '1', '2013-05-27 00:00:00', '1', '2013-05-27 00:00:00', '最高管理员', '0');
...
INSERT INTO `sys_user` VALUES ('9', '7', '10', 'jn_scb', '{bcrypt}$2a$10$0wOwSg/BnCHvC2Qd5biSVOmH8oJvyySJ0CsQj6LipWkisUTqxp4ey', '0009', '济南市场部', '男', '2017-12-29 14:46:13', '', '', '', '', NULL, NULL, NULL, '1', '1', '2013-05-27 00:00:00', '1', '2017-12-26 14:58:03', '', '0');
...
CREATE TABLE `user_info`  (
  ...
  `salt` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '盐',
  `pic_location` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '头像地址',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
...
-- ----------------------------
INSERT INTO `user_info` VALUES (1, 'admin', 'admin', '57060df09a45d6033cb1ab56c16c64f7ec73f7247f19fb91', '13398186770', '7004631516777799', NULL, '2020-04-16 21:52:18', '2020-04-16 21:52:23');
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '虚拟地址表' ROW_FORMAT = Dynamic;
