    ...
    <el-col :span="24" class="header">
      ...
      <el-col :span="4" class="userinfo">
        <el-dropdown trigger="hover">
          <span class="el-dropdown-link userinfo-inner"><img :src="this.sysUser.avatar" /> {{sysUser.name}}</span>
          <el-dropdown-menu slot="dropdown">
            <el-dropdown-item>我的消息</el-dropdown-item>
            <el-dropdown-item @click.native="profile">设置</el-dropdown-item>
            ...
            <template v-if="!item.hidden">
              <el-submenu :index="index+''" :key="index" v-if="!item.leaf">
                ...
                <template v-for="child in item.children">
                  <el-menu-item :key="child.path" :index="item.path+'/'+child.path" v-if="!child.hidden">
                    {{child.name}}
                  </el-menu-item>
                </template>
              </el-submenu>
