...
import com.phuag.sample.common.core.util.Reflections;
    ...
    public boolean save(T entity) {
        if (entity.isNewRecord()) {
            ...
            if (StringUtils.isBlank(entity.getParentId())) {
                ...
                parentEntity = super.getById(entity.getParentId());
            }
            ...
            List<T> list = baseMapper.selectByParentIdsLike(parentIdLike);
            for (T e : list) {
