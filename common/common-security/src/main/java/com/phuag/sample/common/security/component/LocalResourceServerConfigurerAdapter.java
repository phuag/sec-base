 ...
 */
@Slf4j
public class LocalResourceServerConfigurerAdapter extends ResourceServerConfigurerAdapter {
	@Autowired
	...
	@Autowired
	private LocalBearerTokenExtractor pigBearerTokenExtractor;
	...
	public void configure(ResourceServerSecurityConfigurer resources) {
		...
		UserAuthenticationConverter userTokenConverter = new LocalUserAuthenticationConverter();
